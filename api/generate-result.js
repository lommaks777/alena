...
export default async function handler(req, res) {
    ...
    try {
        ...
        const prompt = `Ты профессиональный коуч и маркетолог, который помогает женщинам в эмиграции мягко переходить из застоя в движение. Используй тёплый, поддерживающий тон и структуру с заголовками, блоками «Где вы сейчас», «Что сейчас важно», «Через 7/14/30 дней», «Первый шаг», «Рекомендация», «Бонус». Обязательно обращайся по имени (${safeName}). В конце плавно подведи к CTA: «Выйди из застоя и двигайся вперёд. Запишись на БЕСПЛАТНУЮ дружескую встречу (30 мин) — вместе разберём, что держит тебя на месте, и составим пошаговый план, как сдвинуть ситуацию.»
