...
${highlightsHtml}
<h2 class="section-title">Твои точки роста</h2>
<h3>Через 7 дней</h3>
...
Блок 3: <h2 class="section-title">Твои точки роста</h2>
(Твои точки роста - заменяет "Через 7/14/30 дней")
Подблоки:
- <h3>Через 7 дней</h3>
- <h3>Через 14 дней</h3>
- <h3>Через 30 дней</h3>

Блок 4: <h2 class="section-title">Первый, самый бережный шаг</h2>
(Первый, самый бережный шаг - заменяет "Первый шаг")

Блок 5: <h2 class="section-title">Моя рекомендация для тебя</h2>
(Моя рекомендация для тебя - заменяет "Рекомендация")

Блок 6: <h2 class="section-title">Маленький бонус для настроения</h2>
(Маленький бонус для настроения - заменяет "Бонус")

Блок 7: <h2 class="section-title">Что дальше? Давай поговорим</h2>
(Что дальше? Давай поговорим - НОВЫЙ конверсионный блок)
