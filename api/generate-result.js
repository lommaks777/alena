...
ВАЖНО: Верни результат в HTML формате с красивым оформлением. Используй теги h2, h3, p, ul, li, strong, em для структурирования. Добавь эмодзи для визуального оформления. НЕ оборачивай результат в теги <html> или ```html``` - просто верни чистый HTML код.
